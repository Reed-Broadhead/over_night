    ...
    return(
        <div className="">
            ...
            <div className=" flex flex-row h-full w-full">
                <div className ='text-2xl h-full w-1/3  text-center  text-black flex items-center '>
                    MEET THE LINE UP
                </div>
                <div className="flex flex-row h-full w-2/3"> 
                
                    <div className="w-full h-full  ">
                        <div className="h-[650px] w-[500px] p-2 ">
                            <img className="h-[440px] w-[500px] fit " src={dallas}></img>
                        <h2 className=" text text-2xl mt-3 ">Reed Block</h2>
