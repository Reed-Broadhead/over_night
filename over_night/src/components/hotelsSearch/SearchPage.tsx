...
export default function SearchPage () {
    ...
    const hotelList = hotels[0] ? hotels?.map((hotel: Data) => {
        console.log(hotel)
        return(
            <div className="w-[900px] h-[200px] flex flex-row  mx-auto my-10 shadow-lg border-2 rounded-lg">
                
                <img className=" w-[250px]"src={`http://photos.hotelbeds.com/giata/bigger/${hotel.images[0].path}`} />

                <div className="h-full w-fit max-w-[300px]  flex flex-col p-2">
...
{/* ml-16 */}
                    ...
                    <motion.div className="flex flex-col-reverse items-center  bg-logos-yellow justify-center  border border-logos-yellow mx-auto w-[150px] h-20 my-auto shadow  
                    rounded-md hover:shadow-lg "
                    whileTap={{ scale: 0.98 }}
                    whileHover={{scale: 1.1, backgroundColor: "#FFF506"}}  
